...
# Create function to convert data into Dataframe with the help of DIct ->completed
...
class PredictionPipeline:
    ...
    def predict(self, features):
        preprocessro_path = os.path.join(
            "artifacts/data_transformation", "preprcessor.pkl"
        )
